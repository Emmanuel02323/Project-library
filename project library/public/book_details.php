...
<p>Title: <?php echo htmlspecialchars($title); ?></p> <p>Author: <?php echo htmlspecialchars($author); ?></p> <p>Publication Year: <?php echo
htmlspecialchars($publication_year); ?></p> <p>Available Copies: <?php echo
